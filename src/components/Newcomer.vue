  ...
  >
    <v-card>
      ...
      <v-card-text>
        <!-- 内容部分 -->
        <ul>
          <li class="first-block">这是内部测试版本, 如有 bug 欢迎与开发团队联系</li>
          ...
          <li class="first-block">
            ...
            <ul>
              ...
              <li>&#8226; 在后续的版本更新中, 你将可以自由选择是否以匿名身份发帖</li>
            </ul>
          </li>
          ...
          <li class="first-block">
            安全
            <ul>
              <li>&#8226; 你的注册邮箱和密码已使用哈希算法加密, 即使网站的数据库被攻破也不会有人知道你的密码与真实身份</li>
              <li>
                &#8226; 本站服务器位于中国香港特别行政区, 受当地法律保护。使用本树洞意味着你同意
